...
cprequire_test(["inline:com-chilipeppr-workspace-klzow"], function(ws) {
    ...
    $('title').html("klzow Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-klzow", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-klzow", // Make the id the same as the cpdefine id
        name: "Workspace / klzow", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace klzow.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a klzow
