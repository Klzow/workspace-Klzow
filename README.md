# com-chilipeppr-workspace-klzow
A ChiliPeppr Workspace klzow.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / klzow
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-klzow |
| Name                  | Workspace / klzow |
| Description           | A ChiliPeppr Workspace klzow. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/Klzow/workspace-Klzow/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/klzow/workspace |
| Github URL            | http://github.com/Klzow/workspace-Klzow |
| Test URL              | https://preview.c9users.io/klzow/workspace/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/Klzow/workspace-Klzow/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-klzow"], // the id you gave your workspace
      function(myWorkspaceKlzow) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / klzow just got loaded.", myWorkspaceKlzow);
        myWorkspaceKlzow.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-klzow"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / klzow"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace klzow."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/Klzow/workspace-Klzow/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/klzow/workspace"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/Klzow/workspace-Klzow"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-klzow.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>loadTemplateWidget</td><td>function</td><td>function (callback) <br><br>Load the Template widget via chilipeppr.load() so folks have a klzow
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>load3DviewerWidget</td><td>function</td><td>function (callback) <br><br>Load the 3D-viewer widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
